...
- **Run 0 (Top-P pipeline):** end-to-end profiling of the top-p sampling CUDA pipeline (softmax, sort, nucleus, sample) highlights the Radix Sort step as the primary contributor to overall latency at large vocabulary sizes.
