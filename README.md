...
- **Run 0 (Top-P pipeline):** end-to-end profiling of the top-p sampling CUDA pipeline (softmax, sort, nucleus, sample) highlights the Radix Sort step as the primary contributors to overall latency at large vocabulary sizes; see [top_p/README.md](top_p/README.md) for the full breakdown and charts.
...
For the complete tables, charts, and commentary, see [prof/results/run1.md](prof/results/run1.md).
...
For the complete tables, charts, and commentary, see [prof/results/run2.md](prof/results/run2.md).
