...
__global__ void radix_v3(
    ...
    if (gid < vocab_size) {
        ...
        unsigned int ai = input_indices_batch[gid];
        int is_one = (a >> bit) & 1;
        int idx;
...
extern "C" void solve_radix_v3(
    ...
    unsigned int *d_block_sums, *d_total_ones;
